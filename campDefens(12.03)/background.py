...
class Snow:
    ...
    def __init__(self):
        ...
        self.frame = 0
        self.total_frames = 0.0
        self.image = load_image('image\\snowflake.png')

    def update(self, frame_time):
        self.total_frames += Snow.FRAMES_PER_ACTION * Snow.ACTION_PER_TIME * frame_time
        self.frame = int(self.total_frames) % 4

    def draw(self):
        self.image.clip_draw(500 * self.frame,0,500,300,self.x,self.y,1000,600)
...
class Rain:
    ...
    def __init__(self):
        ...
        self.frame = 0
        self.total_frames = 0.0
        self.image = load_image('image\\rain.png')
    ...
    def draw(self):
        self.image.clip_draw(1000 * self.frame,0,1000,600,self.x,self.y,1000,600)