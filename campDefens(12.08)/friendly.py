...
class Heroine:
    ...
    def handle_run(self, frame_time):
        self.total_frames += Heroine.FRAMES_PER_ACTION * Heroine.ACTION_PER_TIME * frame_time * self.speed_state
        self.frame = int(self.total_frames) % 10
        self.x -= Heroine.RUN_SPEED_PPS * frame_time * self.speed_state
        self.y -= (Heroine.RUN_SPEED_PPS * frame_time)/2 * self.speed_state
    ...
    def handle_die(self, frame_time):
        global stage_life
        stage_life.life -= friendly_data['Heroine']['life']
        self.alive = False
...
class Amazon:
    ...
    def handle_run(self, frame_time):
        self.total_frames += Amazon.FRAMES_PER_ACTION * Amazon.ACTION_PER_TIME * frame_time * self.speed_state
        self.frame = int(self.total_frames) % 10
        self.x -= Amazon.RUN_SPEED_PPS * frame_time * self.speed_state
        self.y -= (Amazon.RUN_SPEED_PPS * frame_time)/2 * self.speed_state
    ...
    def handle_die(self, frame_time):
        global stage_score
        stage_score.score -= friendly_data['Amazon']['score']
        self.alive = False
...
class General:
    ...
    def handle_run(self, frame_time):
        self.total_frames += General.FRAMES_PER_ACTION * General.ACTION_PER_TIME * frame_time * self.speed_state
        self.frame = int(self.total_frames) % 6
        self.x -= General.RUN_SPEED_PPS * frame_time * self.speed_state
        self.y -= (General.RUN_SPEED_PPS * frame_time)/2 * self.speed_state
    ...
    def handle_die(self, frame_time):
        global stage_score
        stage_score.score -= friendly_data['General']['score']
        self.alive = False
...
class Soldier:
    ...
    def handle_run(self, frame_time):
        self.total_frames += Soldier.FRAMES_PER_ACTION * Soldier.ACTION_PER_TIME * frame_time * self.speed_state
        self.frame = int(self.total_frames) % 6
        self.x -= Soldier.RUN_SPEED_PPS * frame_time * self.speed_state
        self.y -= (Soldier.RUN_SPEED_PPS * frame_time)/2 * self.speed_state
    ...
    def handle_die(self, frame_time):
        global stage_score
        stage_score.score -= friendly_data['Soldier']['score']
        self.alive = False
